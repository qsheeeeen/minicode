...
function Demo() {
  return (
    <Box flexDirection="column" padding={1}>
      <ToolDisplay name="Read" input={{ path: "src/index.ts", offset: 10, limit: 20 }} output={"line 1\nline 2\nline 3\n..."} />
      <ToolDisplay name="Write" input={{ path: "src/new-file.ts", content: "export const x = 1;\nexport const y = 2;" }} output="Wrote 2 lines to src/new-file.ts" />
      <ToolDisplay name="Edit" input={{ path: "src/utils.ts" }} output={"--- src/utils.ts\n+++ src/utils.ts\n  1 - const x = 1;\n  1 + const x = 42;\n  2   const y = 2;"} />
      <ToolDisplay name="Bash" input={{ command: "bun test" }} output={"✓ 12 tests passed, 0 failed"} />
