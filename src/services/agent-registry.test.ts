...
import { AgentRegistry, type AgentSession, type AgentStatus } from './agent-registry.js';

const createMockSession = (id: string, type: 'main' | 'sub' = 'sub', status: AgentStatus = 'idle'): AgentSession => ({
  id,
  type,
  agent: {} as any,
  status,
